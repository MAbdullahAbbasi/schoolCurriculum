      ...
      {reportData.objectiveSections.length === 0 ? (
        ...
        <div className="student-report-detail-sections">
          {reportData.objectiveSections.map((section, idx) => (
            <section key={`${section.title}-${idx}`} className="student-report-course-section">
                  ...
                  <tbody>
                    {section.rows.map((row, rowIdx) => (
                      <tr key={rowIdx}>
                        ...
                        <td className="student-report-td student-report-td-marks">{row.marks}</td>
                        <td className="student-report-td student-report-td-total-marks">{row.totalMarks}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        {reportData.gradingSchemeRows.length === 0 ? (
          ...
          <div className="student-report-grading-scheme-table-wrapper">
            <table className="student-report-grading-scheme-table">
              ...
              <tbody>
                {reportData.gradingSchemeRows.map((row, idx) => (
                  <tr key={idx}>
