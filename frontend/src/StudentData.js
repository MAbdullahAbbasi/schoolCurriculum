    ...
    <div className="student-data-container">
      ...
      <div className="add-student-section">
        ...
        <form className="add-student-form" onSubmit={handleAddStudent}>
          ...
          >
            <span className="btn-icon-wrap"><IconUpload />{uploading ? 'Uploading...' : (file ? `Upload ${file.name}` : 'Upload file')}</span>
          </button>
        </form>
      </div>
        ...
        <div className="students-table-section">
          <div className="students-table-header-row">
            ...
            <div className="table-actions">
              ...
              >
                <span className="btn-icon-wrap">{selectionMode ? <><IconCancel />Cancel</> : <><IconSelectAll />Select</>}</span>
              </button>
              {selectionMode && (
                <button
                  type="button"
                ...
                >
                  <span className="btn-icon-wrap"><IconDelete />{deletingSelected ? 'Deleting...' : `Delete selected (${selectedRegistrationNumbers.size})`}</span>
                </button>
              )}
              <button
                type="button"
              ...
              >
                <span className="btn-icon-wrap"><IconDelete />{deletingAll ? 'Deleting...' : 'Delete all data'}</span>
              </button>
            </div>
          </div>
                      ...
                      {isEditing ? (
                        ...
                        <>
                          ...
                          <td>
                            ...
                            >
                              <span className="btn-icon-wrap"><IconDelete />{deletingRegistrationNumber === student.registrationNumber ? 'Deleting...' : 'Delete'}</span>
                            </button>
                          </td>
                        </>
                      )}
