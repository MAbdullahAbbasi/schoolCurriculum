...
const PAGE_RULES = [
  ...
  { test: (p) => p.startsWith('/download-reports/result-sheet'), title: 'Result Sheet', subtitle: 'Session result sheet for download reports.' },
  { test: (p) => p.startsWith('/download-reports'), title: 'Download Reports', subtitle: 'Select grade and exam session to download session-specific report PDFs.' },
  ...
  { test: (p) => p.startsWith('/reports'), title: 'Reports', subtitle: 'Select a grade to view students and results across saved marks.' },
